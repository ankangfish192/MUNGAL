...
/**
 * 【模联重逢录】最终实装稳定版 - 纯 CG 叙事模式
 * 
 * 修改说明：
 * 1. 适配 7 张关键 CG 的叙事逻辑。
 * 2. 移除了旧的背景和立绘引用。
 * 3. 优化了转场逻辑，确保每张 CG 都能对应正确的剧情。
 */

const ASSETS = {
  // 关键 CG 资源 (请确保图片已放入 public 文件夹)
...
const App = () => {
  const [stage, setStage] = useState('TITLE'); // TITLE, PLAYING, ENDING
  ...
  const script = [
    ...
    },
    {
      ...
      isChoice: true,
      choices: [
        { label: "“询问具体的直升机型号”", nextIndex: 5 },
        { label: "“保持沉默，观察她的反应”", nextIndex: 5 }
      ]
    },
    {
      bg: ASSETS.CG_04,
    ...
    },
    {
      ...
      isChoice: true,
      choices: [
        { label: "“……好。我的老同伴。”", nextIndex: 10 },
        { label: "“那你要分我吃肠粉才行。”", nextIndex: 10 }
      ]
    },
